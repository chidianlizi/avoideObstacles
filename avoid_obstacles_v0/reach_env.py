...
class MySimpleReachEnv(gym.Env):
    ...
    def _add_obstacles(self):
        ...
        obsts = []
        obst_x = (self.init_home[0]+target_x)/2
        obst_y = (self.init_home[1]+target_y)/2
        obst_z = (self.init_home[2]+target_z)/2
        obst_id = p.createMultiBody(
                        baseMass=0,
                        baseVisualShapeIndex=self._create_visual_box([0.002,0.04,0.05]),
                        baseCollisionShapeIndex=self._create_collision_box([0.002,0.04,0.05]),
    ...
    def _add_moving_plate(self):
        ...
        obst_id = p.createMultiBody(
                        baseMass=0,
                        baseVisualShapeIndex=self._create_visual_box([0.1,0.1,0.002]),
                        baseCollisionShapeIndex=self._create_collision_box([0.1,0.1,0.002]),
                        basePosition=pos
                    )
        return obst_id
